...
const Register = () => {
    return (
        <div className='flex justify-center mt-8 bg-base-200 rounded-lg'>
            <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none border-2 px-5 py-3 my-20">
