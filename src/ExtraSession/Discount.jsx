    ...
    return (
        <div>
            <div>
                ...
                <div className='lg:flex justify-evenly items-center bg-[#e4e5f5] p-5 rounded-lg'>
                    <img className='w-[350px] h-[300px] mb-3 rounded-lg' src="https://i.ibb.co/jJNsGcX/108.jpg" alt="" />
                    <div>
